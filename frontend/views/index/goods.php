            ...
            <div class="preview fl">
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php var_dump($goods->logo)?>',largeimage: 'images/preview_l1.jpg'}"><img src="images/preview_s1.jpg"></a>
                            </li>
                            <li>
