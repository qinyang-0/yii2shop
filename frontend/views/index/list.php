...
<div class="list w1210 bc mt10">
        ...
        <div class="breadcrumb">
            <h2>当前位置：<?=\yii\helpers\Html::a('首页',['index/index'])?> > <?=$p_name?></h2>
        </div>
    <div class="list_left fl mt10">
        ...
        <div class="catlist">
            ...
            <div class="catlist_wrap">
                <?php foreach ($lists as $k=>$list)://遍历所有一级分类?>
                <div class="child">

                    <h3 class="no"><b></b><?=$list->name?></h3>
                    <ul>
                    <?php foreach ($list->children as $k2=>$child)://遍历该一级分类的子分类（二级分类）?>
                        <?=\yii\helpers\Html::a($child->name,['index/goods','cate_id'=>$child->id])?>
                    <?php endforeach;?>
    ...
    <!-- 左侧内容 start -->
        ...
        <div class="viewd leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <?php foreach($goodss as $k=>$goods)://遍历该一级分类的子分类（二级分类）?>
                <dl>



                    <dt><?=\yii\helpers\Html::img($goods->logo,['index/goods','cate_id'=>$goods->id])?></dt>
                    <dd><?=\yii\helpers\Html::a($goods->name,['index/goods','cate_id'=>$goods->id])?></dd>
                    <?=333?>
                    <?php endforeach;?>
                </dl>
                ...
                <ul>
                    <li>
                        <dl>
                            ...
                            <dd class="name"><a href="">（i5-2450M 2G 5</a></dd>
